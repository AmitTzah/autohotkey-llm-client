...
(function(root, factory) {
  ...
  var messages = {
    ...
    'setChatButtonsEnabled': { dir: 'ahk->web', fields: ['enabled', 'threadId'], required: ['enabled'] },
    ...
    'threadSettings': { dir: 'ahk->web', fields: ['model', 'systemMessage', 'systemOverrideSet', 'reasoning', 'temperature', 'reasoningOverrideSet', 'temperatureOverrideSet', 'webSearch', 'imageGeneration', 'fontSize', 'assistantName', 'assistantBaseModel', 'assistantDescription', 'thinkingLevels', 'supportsTemperature'], required: ['model'] },
    ...
    'completionSoundSelected': { dir: 'ahk->web', fields: ['path'], required: ['path'] },
    ...
    'cancelStream': { dir: 'web->ahk', fields: ['threadId'], required: [] },
    ...
    'browseCompletionSound': { dir: 'web->ahk', fields: ['path'] },
    'testCompletionSound': { dir: 'web->ahk', fields: ['soundType', 'customPath'], required: ['soundType'] },
